...
\fancyhead[L]{\small NDU: Electronic Companion}\fancyhead[R]{\small Anonymous}
\fancyfoot[C]{EC--\thepage}\setlength{\headheight}{14pt}
\hypersetup{pdftitle={Electronic Companion: NDU Endogenous Service Contracts},pdfauthor={Anonymous}}
\begin{document}
\begin{center}
{\Large\bfseries Electronic Companion\par}
\medskip
{\large Neural Differential Utility:\ Endogenous Service Contracts and Certified Dynamic Optimization\par}
\medskip
{Revision R4, September 20, 2026}
\end{center}
This companion retains supporting derivations, counterexamples, implementation details, and the mapping of historical evidence. Equation and theorem references without an EC prefix refer to the main paper. The canonical operating model is the externally priced, perishable-inventory contract model of Section~2. Historical internal-penalty examples are retained as distinct models, not silently identified with that model.
...
\input{revisions/or-r4-20260920/sections/companion_execution_history.tex}
