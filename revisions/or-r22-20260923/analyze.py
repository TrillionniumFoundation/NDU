...
def run():
    ...
    save('matched.tex',table('Complete matched-target pipelines after certificate-price repair.','tab:r22-cost','lrrrrr',
    ...
    save('validation.tex',table('Independent deterministic deployment against reoptimized time-only amendments.','tab:r22-validation','llrrr',
    ...
    for tol,name,lab in [(1e-5,'scaling.tex','tab:r22-scaling'),(.001,'scaling_coarse.tex','tab:r22-scaling-coarse')]:
        rr=[]
    ...
    save('geometry.tex',table('Actual geometry in the new independent validation populations.','tab:r22-geometry','lrrrrr',
    ...
    save('setup.tex',table('Measured scaling offline work and formulation sizes.','tab:r22-setup','lrrrrrr',
