...
For the probabilities, caps, and quadratic rewards in Proposition~\ref{prop:r34-offcap}, the minimum loss over all codebooks with at most two levels under \eqref{eq:r37-overrun} is \eqref{eq:r37-risk-frontier}. In particular, the optimal highest level is continuous in $\delta$ on $[0,1/8]$ and is off-cap for every $\delta>0$.
\end{proposition}
\begin{proof}
