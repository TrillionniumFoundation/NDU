\section{Certificate structure and fixed-decision price repair}\label{sec:r21-certification}
...
\begin{theorem}[Certificate components and an irreducible price-repair floor]\label{thm:r21-decomposition}
...
\begin{align}
 ...
 +\underbrace{\mu^\top(a-Ay)}_{G_{\rm acceptance}}.\label{eq:r21-components}
\end{align}
...
\begin{proposition}[Small-dimensional monotone certificate repair]\label{prop:r21-polishing}
...
\begin{equation}\label{eq:r21-polishgradient}
 \nabla Q(p,\nu)=(p-Uz,-Ez).
\end{equation}
...
\begin{equation}\label{eq:r21-polishhessian}
 \begin{pmatrix}
...
\begin{equation}\label{eq:r21-regularization}
