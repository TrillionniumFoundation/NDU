"""Validate actual R21 manuscripts and evidence; frozen verification never mutates."""
...
def run():
    ...
    assert 'Revision R21' in md[0].get_text() and 'Revision R21' in ed[0].get_text()
    ...
    for name in ['matched_summary','validation_summary','theory_checks','replay','analysis']:
    ...
    out={'status':'PASS','revision':'R21','main_pdf_pages':len(md),'main_reference_pages':refpages,
