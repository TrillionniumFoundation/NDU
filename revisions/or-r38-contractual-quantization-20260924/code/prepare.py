...
\par\vspace{.15in}\textbf{Keywords:} renewal contracts; quantization; participation; dynamic programming.
...
ec=preamble+'\\externaldocument{r38-main-labels}[main.pdf]\n'
...
ec+=inp('derived/methodology.tex')+inp('derived/legacy_evidence.tex')
