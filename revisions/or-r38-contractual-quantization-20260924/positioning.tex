...
The adjacent lottery is exactly the classical unbiased two-point quantizer. For $u\leq b\leq v$,
...
Continuous top level & Optimized quantizer grids and interpolation & Cap-anchored representation combined with a heterogeneous, one-sided contractual tail; exact off-cap optimum.\\[3pt]
...
Promise robustness & Concave allocation and Lipschitz comparison & Same-alphabet lifts give uniform bounds for both institutions and an explicit strict nonsaturated advantage.\\[3pt]
Charged risk catalog & Ordered shortest paths & Exact risk-eligibility edge costs and actual level charges jointly optimize service and implementation.\\\bottomrule
\end{tabular}
\end{table}
