...
BASE='a149cb3e5df35e33e64a148d7d620e019ca2b135'
REVIEW='1cf9c8df76437ee71d4291d1001e9c7f055781c5'
BRANCH='revision/ndu-operations-research-r39-robust-quantizer-20260924'
B=ROOT/'.build/ndu-r39'; B.mkdir(parents=True,exist_ok=True)
...
def prepare():
    preservation()
    for script in ('verify.py','verify_allocation.py','study.py','inherited.py','prepare.py'):
...
def build():
    ...
    response_tex()
    for _ in range(4):
        compile_one('main.tex'); labels('main','r39-main-labels.aux')
        compile_one('electronic_companion.tex'); labels('electronic_companion','r39-ec-labels.aux')
    ...
    for name in ('verification.json','allocation_validation.json','catalog_study.json','inherited.json'):
