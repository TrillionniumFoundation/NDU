...
The full accounting decomposition appears in Table~\ref{tab:ledger}. For example, the joint policy earns more premium but also pays more liability, maintenance, and adjustment. Equation~\ref{eq:identity} accounts for all these changes. No historical total-cost field is relabeled as theta-free physical cost.
