...
This section supplies a common formulation for the scalar contract model, joint service portfolios, and continuation participation. Critical-fractile analysis and convex first-order optimality are established tools; the supporting-price interpretation identifies their role here. The primitive tree criterion in Section~\ref{sec:r10-tree}, rather than the optimality conditions themselves, is the structural result used to diagnose accepted adaptation.
