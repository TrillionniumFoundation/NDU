...
## Main change: a box oracle rather than a renamed target grid
...
## R1. Complexity frontier and repeated branch types
...
## R3. Global accuracy and independent coverage
...
## R4. Joint experiments versus heuristics
...
## R5. Independent comparisons and matched objectives
...
## R6. Stronger large-instance certificates and inexact supports
...
## R7. Application scope, presentation, and preservation
...
## M1. One-branch target-net redundancy

The new target_net_reference.py returns the exact conditional frontier after one call at the forced target. The regression explicitly checks evaluated_profiles equals one. The archived R45 implementation is not overwritten.

## M2. Clipping regression
...
## M5. Saturated algorithm provenance
...
## M7. Exponential accuracy dependence
...
## M9. Charged counterexample scale
...
## M12. Conditional scaling distinction
...
## M15. Selected versus used levels
...
## M18. Numerical versus rational evidence
