...
python revisions/or-r44-resource-augmentation-20260924/code/build.py prepare
python revisions/or-r44-resource-augmentation-20260924/code/build.py build
...
REVIEW='a0d1f4e3dfc3f7639f806cab01f1faae877d5361'
BRANCH='revision/ndu-operations-research-r44-resource-augmentation-20260924'
B=ROOT/'.build/ndu-r44'; B.mkdir(parents=True,exist_ok=True)
...
def build():
    ...
    response_tex()
    for _ in range(4):
        compile_one('main.tex'); labels('main','r44-main-labels.aux')
        compile_one('electronic_companion.tex'); labels('electronic_companion','r44-ec-labels.aux')
